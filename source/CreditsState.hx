...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['CrashyJuny',	'crashyjuny',		"Easy/Normal Charts, Coder",			'',												'2e74ff'],
			['Vastor',		'vastor',			"Chart, Coder",			'https://www.youtube.com/@Vastor6624',			'ac27ff'],
			['Thatou',		'thatou',			"Voice acting, helped with the arts",			'https://www.youtube.com/@Thatou0_0',			'ff00ff'],
			[''],
			["Special Thanks"],

...
class EditorPlayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		if (PlayState.SONG.needsVoices)
			vocals = new FlxSound().loadEmbedded(Paths.voices(PlayState.SONG.song, CoolUtil.getDifficultyFilePath()));
		else
			vocals = new FlxSound();
	...
	{
		FlxG.sound.playMusic(Paths.inst(PlayState.SONG.song, CoolUtil.getDifficultyFilePath()), 0, false);

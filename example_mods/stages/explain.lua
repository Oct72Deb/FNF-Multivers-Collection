...
function onStepHit()
	if curStep == 32 then
		...
		makeLuaSprite('1', 'bg/howtoplay/EN/1', 170, 505);
...
if curStep == 128 then
	...
	makeLuaSprite('2', 'bg/howtoplay/EN/2', 170, 510);
...
if curStep == 192 then
	...
	makeLuaSprite('3', 'bg/howtoplay/EN/3', 170, 530);
...
if curStep == 256 then
	...
	makeLuaSprite('4', 'bg/howtoplay/EN/4', 170, 500);
...
if curStep == 320 then
	...
	makeLuaSprite('5', 'bg/howtoplay/EN/5', 170, 505);
...
if curStep == 512 then
	...
	makeLuaSprite('6', 'bg/howtoplay/EN/6', 170, 530);

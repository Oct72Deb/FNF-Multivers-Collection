...
idleOffsets = {'43', '79'}        -- I recommend you have your idle offset at 0
leftOffsets = {'137', '52'}
downOffsets = {'34', '48'}
upOffsets = {'104', '127'}
rightOffsets = {'117', '29'}
...
left_miss_xml_name = ''   -- use as required
down_miss_xml_name = ''
up_miss_xml_name = ''
right_miss_xml_name = ''

left_alt_xml_name = ''     -- use as required
down_alt_xml_name = ''
up_alt_xml_name = ''
right_alt_xml_name = ''
